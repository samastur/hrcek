...
Hrček stores references to interesting content found on the web. It is
built for family-scale use, and its design reflects that: SQLite, one
process, no queue.
...
- [Debugging and telemetry](debugging-and-telemetry.md) — logs, the
  debugger, Sentry
- [Deployment](deployment.md) — running it for real
- [Contributing](contributing.md) — the definition of done
